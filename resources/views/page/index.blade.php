@include('header')
        <div class="first-screen">
            <div class="header-left text-center">
                <a>
                    <img src="/img/icon_home.png" width="27" />
                </a>
                ...
                <div>
                    <a class="left-icon left-icon-1 display-block">
                        <img src="img/icon_inst.png" width="30" />
                    </a>
                    <a class="left-icon left-icon-2 display-block">
                        <img src="img/icon_calendar.png" width="30" />
                    </a>
                    <a class="left-icon left-icon-3 display-block">
                        <img src="img/icon_weather.png" width="30" />                    
                    </a>
                </div>
            </div>
            <div class="header-right">
                <div class="row">
                    ...
                    <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1 text-center">
                        <img src="/img/icon_user.png" width="27" />
                    </div>
                </div>
                <div class="row">
        ...
        <div class="background-body">
            ...
            <div class="background-safety-mountains">
